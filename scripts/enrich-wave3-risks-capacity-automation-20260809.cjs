...
inject('dossiers/assurer-ou-autoassurer-risques.html', 'CE_DATA_WAVE3_20260809:dossiers/assurer-ou-autoassurer-risques.html', '</div><h2>1. Penser en gravité avant de penser en probabilité</h2>', insuranceBlock + '<h2>1. Penser en gravité avant de penser en probabilité</h2>');
inject('dossiers/dependance-gros-client.html', 'CE_DATA_WAVE3_20260809:dossiers/dependance-gros-client.html', '</div><h2>1. Le bon chiffre n’est pas seulement 60 % du CA</h2>', clientBlock + '<h2>1. Le bon chiffre n’est pas seulement 60 % du CA</h2>');
inject('dossiers/embaucher-ou-sous-traiter.html', 'CE_DATA_WAVE3_20260809:dossiers/embaucher-ou-sous-traiter.html', '</div><h2>1. Vérifier d’abord pourquoi vous manquez de capacité</h2>', hireBlock + '<h2>1. Vérifier d’abord pourquoi vous manquez de capacité</h2>');
inject('dossiers/automatiser-ou-non-processus.html', 'CE_DATA_WAVE3_20260809:dossiers/automatiser-ou-non-processus.html', '</div><h2>1. Commencer par le processus actuel</h2>', autoBlock + '<h2>1. Commencer par le processus actuel</h2>');
