(() => {
  ...
  const catalog = [...toolsCatalog, ...contentCatalog];
  ...
  const aliases = {
    ...
    outil:'simulateur calculateur modèle tableur',simulateur:'outil calculateur emprunt crédit capacité',calculateur:'outil simulateur tableur',tableur:'outil calculateur modèle',
