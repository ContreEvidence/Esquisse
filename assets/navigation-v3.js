(() => {
  ...
  style.textContent = `
    ...
    .ce-contact-link,.ce-start-link{display:inline-flex;align-items:center;justify-content:center;min-height:40px;padding:.56rem .76rem;border-radius:999px;text-decoration:none;font-size:.78rem;font-weight:850;white-space:nowrap}
    .ce-start-link{background:#fff;color:#101820;border:2px solid #d4ab56}
    .ce-contact-link{background:#d4ab56;color:#0b0b0c;border:1px solid #e8c979}
    .ce-start-link:hover,.ce-start-link:focus-visible,.ce-contact-link:hover,.ce-contact-link:focus-visible{background:#e8c979;color:#000;outline:2px solid #fff;outline-offset:2px}
    ...
    .ce-flat-links{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:.35rem;padding:.36rem 0 .42rem}
    .ce-flat-link{position:relative;display:flex;align-items:center;justify-content:center;min-height:44px;padding:.55rem .5rem;color:#e9edef;text-decoration:none;text-align:center;font-size:1.04rem;font-weight:850;line-height:1.08;background:transparent;border:0;border-radius:7px;white-space:nowrap}
    ...
    .ce-flat-link[data-key="bibliotheque"]{font-weight:750;color:#cfd6da}
